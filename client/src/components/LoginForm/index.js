      ...
      <Col>
        ...
        <Form onSubmit={onSubmit} className="p-4" style={{backgroundColor: "#26004d", color:"white"}}>
          <Form.Group controlId="formBasicEmail">
            ...
            <Form.Control name="email" style={{fontFamily: 'Red Rose'}}  onChange={handleChange} className="timer" type="email" placeholder="Enter email" value={payload.email}/>
          ...
          <Form.Group controlId="formBasicPassword">
            ...
            <Form.Control value={payload.password} style={{fontFamily: 'Red Rose'}} name="password" onChange={handleChange} className="timer" type="password" placeholder="Password" />
            {errors.map((error) => (
